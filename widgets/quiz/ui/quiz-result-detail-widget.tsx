...
import { Title, useResultStyles, Slogan, List } from '@/features/quiz';
...
interface QuizResultDetailWidgetProps {
  resultId: string;
}

export const QuizResultDetailWidget = ({
  resultId,
}: QuizResultDetailWidgetProps) => {
