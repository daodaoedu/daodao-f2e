    ...
    <>
      ...
      >
        <List className="my-9">
          ...
          <li>
            若16歲以下有高度申請動機，且經法定代理人同意者，歡迎寄信給主辦單位。
          </li>
        </List>
        <p className="mb-2.5">
      ...
      >
        ...
        <List className="list-decimal">
          ...
          <li>
            成為助人者，完成整趟學習馬拉松者將獲得自主學習引導師優先培訓機會
          </li>
        </List>
      </Section>
      ...
      <Section title="成果發表與獎勵" id="marathon-reward" className="bg-white">
        <p className="mb-8 mt-3">
          在學習馬拉松尾聲，針對入選的 20
          位學員，島島阿學將舉辦成果分享日，並邀請引導師及入選者作為評審，更提供總獎金
          NT$ 25,000元 支持優秀計畫持續發展！
        </p>
          ...
          <li>
            ...
            <List>
              ...
              <li>
                ...
                期間，將自己的成果分享到任意社群媒體，並附上官方活動資訊，主辦單位將根據
                2025/7/11 17:00
                所有社群媒體累積的按讚決定得獎者。（詳細辦法將於入選後公告）
              </li>
            </List>
          </li>
          <li>
      ...
      <Section className="px-6 py-8 text-center md:py-[50px]">
        <ApplyButton className="mx-auto inline-block h-10 rounded-[20px] bg-[#16B9B3] px-5 py-2.5 text-base font-normal leading-[140%] text-white hover:bg-[#16B9B3] hover:shadow-[0px_4px_10px_0px_rgba(89,182,178,0.50)]">
          立即申請
        </ApplyButton>
      </Section>
    </>
