...
const q3: QuestionType = {
  ...
  answers: [
    ...
    { key: "C", value: 1, title: "開始聊天並加入島民的日常生活" },
    { key: "D", value: 1, title: "對島民察言觀色並思考原因" },
    { key: "L", value: 1, title: "思考彼此差異及合作的可能性" },
  ],
};
...
const q4: QuestionType = {
  ...
  answers: [
    ...
    { key: "L", value: 1, title: "發現挑戰相互關聯，決心打造通關邏輯系統" },
    { key: "D", value: 1, title: "先查閱歷史紀錄與過往參賽者的心得" },
    { key: "A", value: 1, title: "直接報名參加，邊玩邊解決問題" },
  ],
};
...
const q5: QuestionType = {
  ...
  answers: [
    ...
    { key: "A", value: 1, title: "設計一份超簡單雙語學習卡，快速教大家" },
    { key: "O", value: 1, title: "建立詞彙對照表，把語句依功能分類成表格" },
    { key: "C", value: 1, title: "拉島民們一起幫忙交流" },
  ],
};
...
const q6: QuestionType = {
  ...
  answers: [
    ...
    { key: "C", value: 1, title: "召集大家集思廣益，統一行動方向" },
    { key: "L", value: 1, title: "設計一種用簡單材料快速搭建的避難屋" },
    { key: "O", value: 1, title: "畫出撤退路線圖與分組安排表" },
  ],
};
...
const q7: QuestionType = {
  ...
  answers: [
    ...
    { key: "D", value: 1, title: "一本記錄這座島一切知識的手抄本" },
    { key: "C", value: 1, title: "一張可以看懂島民關係的社群圖" },
    { key: "L", value: 1, title: "一組可以任意變化的萬用法寶" },
  ],
};
...
const q8: QuestionType = {
  ...
  answers: [
    ...
    { key: "L", value: 1, title: "創作一段融合神話與科技的未來故事" },
    { key: "C", value: 1, title: "收集大家的想像，拼出共同願景" },
    { key: "A", value: 1, title: "提案三個馬上能做的改善小任務" },
  ],
};
...
const q9: QuestionType = {
  ...
  answers: [
    ...
    { key: "D", value: 1, title: "仔細研究箱子的外型再評估是否打開" },
    { key: "A", value: 1, title: "直接打開並把東西拿來幫助島民" },
    { key: "O", value: 1, title: "把裡面東西一樣樣分類記錄與分配" },
  ],
};
