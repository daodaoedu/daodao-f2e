...
const deepExplorer: ResultDetailType = {
  id: "d",
  tags: ["注重推理", "熱愛觀察"],
...
const activeShaper: ResultDetailType = {
  id: "a",
  tags: ["熱愛動手做", "行動派"],
  slogan: "先做再說，做中學最快！",
...
const communityConnector: ResultDetailType = {
  id: "o",
  tags: ["結構腦", "善規劃"],
  slogan: "先做再說，做中學最快！",
  ...
  islandDiningDescription: "四季春珍波椰、肉粽，可以明確知道有哪些食材就給讚！",
  recommendedResources:
...
const liquidIntegrator: ResultDetailType = {
  id: "l",
  tags: ["跨領域", "多元思考"],
...
const orderBuilder: ResultDetailType = {
  id: "c",
  tags: ["共學共好", "善於察覺"],
