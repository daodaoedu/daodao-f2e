...
// ---------------------------------------------------------------------------
// Manual extensions – Practice item response shape (not yet in OpenAPI spec)
// ---------------------------------------------------------------------------
...
export interface PracticeItem {
  ...
  status?: string | null;
  /** privacy_status: "private" | "public" | "delayed" */
  privacy_status?: string;
  /** Aggregated reactions for this practice */
  reactions?: PracticeReaction[];
  /** True when privacy_status == "delayed" && status == "active" (brewing card) */
  is_brewing?: boolean;
