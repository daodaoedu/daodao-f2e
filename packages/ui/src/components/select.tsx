...
function SelectTrigger({
  ...
  return (
    <SelectPrimitive.Trigger
      ...
      className={cn(
        "flex h-10 w-full items-center justify-between gap-2 rounded-lg border border-bg-gray hover:border-logo-cyan bg-background text-sm ring-offset-background",
