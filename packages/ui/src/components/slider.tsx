...
const SliderContext = React.createContext<SliderContextType | undefined>(
  undefined
);
...
>(({ className, value, defaultValue, children, formatValue, renderTooltip, ...props }, ref) => {
  ...
  return (
    <SliderContext.Provider value={{ value: currentValue, formatValue, renderTooltip, isDragging, setIsDragging }}>
