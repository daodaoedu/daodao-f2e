...
export const posthogSetPersonProperties = (properties: Record<string, unknown>) => {
  if (typeof window !== "undefined" && window.posthog) {
    window.posthog.setPersonProperties(properties);
  }
};

export const posthogOptOut = () => {
  if (typeof window !== "undefined" && window.posthog) {
    window.posthog.opt_out_capturing();
  }
};

export const posthogOptIn = () => {
  if (typeof window !== "undefined" && window.posthog) {
    window.posthog.opt_in_capturing();
  }
};

export const posthogIsFeatureEnabled = (key: string): boolean => {
  if (typeof window !== "undefined" && window.posthog) {
...
export const posthogGetFeatureFlag = (key: string): string | boolean | undefined => {
  if (typeof window !== "undefined" && window.posthog) {
