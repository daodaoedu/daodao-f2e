    ...
    <TermsWrapper>
      <PaperWrapper>
        ...
        <p>
          ...
          ，以下簡稱「本網站」）尊重他人的智慧財產權，希望提供一個不包含侵犯這些權利的內容平台。我們的使用者協議要求會員發布的資訊準確、合法且不侵犯第三方的權利，這個要求包含本網站所舉辦的任何型態活動。
        </p>
        <p>
        ...
        <ol>
            ...
            <ol className="sublist">
              ...
              <li>
                <p>
                  ...
                  <a
                    href="https://creativecommons.org/licenses/by-sa/4.0/legalcode.zh-hant"
                    target="_blank"
                    rel="noreferrer"
                  >
                    {' '}
          ...
          <li>
            ...
            <ol className="sublist">
              <li>
                <p>
                  除採前述貢獻提供內容外，您亦可透過表格、附錄，補充「描述」欄位說明的方式，表達您指定特一款或多款公眾授權條款，或宣告模式為輔助授權條款之意向。此時該等貢獻內容，除依本條款第2條規定之方式授權本網站外，同時亦依指定條款雙重／多重授權予本網站。您所指定的輔助條款，並不拘束管理者，但在處理方式容許的前提下，管理者得尊重您的指定，除依管理者指定、揀選的授權條款外，同時一併採用輔助條款來散布該等貢獻內容。倘您於輔助條款裡列入「
                  CC0
            ...
            <ol className="sublist">
              <li>
                <p>
                  ...
                  ，由本網站在固定會議中或透過其他管道為您處理。紛爭解決和管轄法院。依本使用者條款所產生之爭議，雙方合意以臺灣臺北地方法院為第一審管轄法院。
                </p>
              </li>
            </ol>
          </li>
