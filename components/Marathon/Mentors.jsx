...
const mentors = [
  {
    ...
    tags: ['島島阿學共同發起人', '臺灣實驗教育勞動合作社共同發起人', 'g0v零時小學校專案經理'],
    social: {
      facebook: {
        text: 'tiff.lin.1',
...
const Tag = ({ text, className }) => (
  <div
    title={text}
    className={cn("px-2 py-0.5 body-sm bg-primary-lightest text-basic-400 rounded-[4px] truncate", className)}
  >
    {text}
  </div>
);
