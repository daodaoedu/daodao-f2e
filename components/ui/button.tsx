  ...
  ),
  {
    variants: {
      variant: {
        ...
        ctaOrange:
          'border-2 border-tips bg-tips text-white shadow-[0_8px_10px_0_rgba(255,161,11,0.2)] hover:!bg-white hover:!text-tips hover:-translate-y-0.5 hover:shadow-[0_12px_20px_0_rgba(255,161,11,0.3)] active:translate-y-0',
        ctaOrangeSmall:
        ...
        ctaPrimary:
          'border-2 border-primary-base bg-primary-base text-white shadow-[0_8px_10px_0_rgba(22,185,179,0.2)] hover:!bg-white hover:!text-primary-base hover:-translate-y-0.5 hover:shadow-[0_12px_20px_0_rgba(22,185,179,0.3)] active:translate-y-0',
      },
      size: {
