  ...
  return (
    ...
    >
      <div className="container mx-auto h-full flex flex-col justify-start">
        <div className="flex flex-col items-center justify-center md:flex-row w-full space-y-8">
        <div className="text-center md:text-left w-full md:max-w-[44%] xl:max-w-[30%]">
          <SectionHeader
            title={
              <>
                了解你的學習偏好，<br />
