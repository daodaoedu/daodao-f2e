export const SEARCH_TAGS = {
  language: ['中文', '英語', '有聲書', '聽力', '單字', '閱讀', '多語言型學習資源', '口說', '寫作', '日文'],
  math: ['數學', '邏輯'],
  comsci: ['程式設計', '中文介面'],
  art: ['圖片素材', '設計', '排版素材', '戲劇', '繪畫', '音樂', '藝文資訊', '攝影'],
  natusci: ['物理', '化學', '生物', '地科', '動畫'],
  humanity: ['歷史', '文化', '法律', '政治', '經濟', '國際情勢', '社會議題', '哲學'],
  education: ['實驗教育', '自主學習', '民主教育', '生涯探索', '升學資訊', '教學方法', '教育創新'],
  life: ['烘焙烹飪', '食農', '媒體', '旅遊', '攝影'],
  health: ['運動', '心理', '醫學'],
  business: ['投資理財', '公關行銷', '社會創新', '人力資源'],
  multires: ['MOOC', '多元學習類型', '學科類型'],
};
