...
const LoginPage = () => {
  ...
  useEffect(() => {
    ...
    window.addEventListener('message', onMessageChange);

    return () => {
      window.removeEventListener('message', onMessageChange);
    };
  }, []);
    ...
    <>
      ...
      <Box sx={{ minHeight: '100vh' }}>
        <ContentWrapper>
          ...
          />
          <Button
            onClick={() => openLoginWindow('/learning-marathon/signup', LOGIN_PATH)}
            sx={{
              width: '100%',
              marginTop: '24px',
              borderRadius: '20px',
