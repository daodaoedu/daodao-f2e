...
import type { Practice, PracticeStats, PracticesResponse, CheckIn } from '@/types/practice'
...
export function useCheckIn() {
  ...
  const checkIn = useCallback(async ({ practiceId, note }: CheckInParams): Promise<CheckInResult> => {
