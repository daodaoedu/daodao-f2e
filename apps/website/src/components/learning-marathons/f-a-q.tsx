...
const faqItems: FaqItem[] = [
  {
    ...
    answer: (
      <p>我們歡迎你邀請朋友一起申請，多人申請會有團報優惠價，但如果只有你自己的話也沒問題！</p>
    ),
  },
  {
    id: "group-selection",
  ...
  },
  {
    ...
    answer: <p>僅有工作坊會有錄影，學習小組會議、引導師諮詢、社群活動等不會有錄影。</p>,
  },
  {
    ...
    answer: (
      <p>
        每位入選者的最終成果會公開在島島網站上，除了本次活動入選者外，其他使用者也能了解你在這 5
        個月的學習歷程。
      </p>
    ),
  },
  ...
  },
  {
    ...
    question: "我可以繳交多件計畫嗎？",
    answer: (
      <p>在申請期間每人只能提交一件學習計畫，待公告入選者後，使用者可新增至多三個學習計劃。</p>
    ),
  },
  {
      ...
      <div>
        ...
        <div>
          ...
          <ol className="list-decimal pl-6">
            <li>工作坊、學習小組會議、團體諮詢及 1對1 諮詢，加總不得請假超過5小時。</li>
            <li>提交所有每兩週的進度報告。</li>
            <li>參與7/12成果發表日。</li>
            <li>
              於 2025/7/10 前完成以下資料
