...
import { CategoriesContainer, ResourceContainer, SectionTitle } from "@/features/resources";
...
import { HOT_TAGS } from "@/src/constants/category";
...
export const ResourceListPageWidget = ({ data, jsonLd }: ResourceListPageWidgetProps) => {
