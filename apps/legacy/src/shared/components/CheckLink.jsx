...
function InternalCheckLink(_props, ref) {
  const id = useId();
        ...
        <DialogHeader>
          ...
          {link && (
            <DialogDescription id={descriptionId} className="space-y-2">
              ...
              <Text className="break-words text-sm text-gray-500">{decodeURI(link.href)}</Text>
            </DialogDescription>
          )}
        </DialogHeader>
        {link && (
          <>
            <div className="flex items-center space-x-2">
              <Checkbox id="trust-link" checked={isTrust} onCheckedChange={setIsTrust} />
