...
import { CATEGORIES } from "@/src/constants/category";
  ...
  return (
    <Paper className="mx-auto my-5 min-h-[60vh] w-[90%] p-5">
      ...
      <div className="flex flex-col items-center justify-center">
        <img src="/assets/images/nobody-island.gif" alt="nobody-land" width="300" height="300" />
      </div>
      ...
      <div className="my-5">
        <Text className="font-bold">豐富的學習類別</Text>
      ...
      <div className="mb-2.5 mt-10">
        <Text className="font-bold">加入島島社群</Text>
        <div className="my-5">
