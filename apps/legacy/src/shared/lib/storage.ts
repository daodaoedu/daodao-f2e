...
export default function createStorage<T>(
  ...
  const storage = storageType === StorageType.LocalStorage ? localStorage : sessionStorage;
...
export const getIsCheckDragMilestoneStorage = () => createStorage<boolean>("_isCheckDragMilestone");
