...
const measureElement = (
  ...
  if (button) {
    ...
    const space =
      button.offsetWidth + parseFloat(buttonStyle.marginLeft) + parseFloat(buttonStyle.marginRight);
...
export const TextCollapse = ({
  ...
  const displayText = isExpanded ? text : isCalculated && shouldShowButton ? truncatedText : text;
