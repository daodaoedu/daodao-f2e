...
export type ResourceMutationResponseSchema = z.infer<typeof resourceMutationResponseSchema>;

export type ResourceSearchParamsSchema = z.infer<typeof resourceSearchParamsSchema>;
