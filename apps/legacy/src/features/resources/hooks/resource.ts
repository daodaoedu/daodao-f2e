...
import {
  getResourcePathname,
  type ResourceDetailResponseSchema,
  type ResourceListResponseSchema,
  type ResourceMutationResponseSchema,
  type ResourceSearchParamsSchema,
  resourceAPI,
...
export function useResourceList(filter: ResourceSearchParamsSchema) {
  ...
  const swrInfinite = useSWRInfinite<ResourceListResponseSchema>(
    (pageIndex, previousPageData): [string, ResourceSearchParamsSchema] | null => {
...
type SWRMutationOptions<T = ResourceMutationResponseSchema> = SWRMutationConfiguration<
  T,
  Error,
  string | null
>;

export const useCreateResource = ({ onSuccess, ...options }: SWRMutationOptions = {}) =>
  useSWRMutation(getResourcePathname(), resourceAPI.create, {
    ...options,
    onSuccess,
  });
...
export const useUpdateResource = (
  ...
  useSWRMutation(resourceId ? getResourcePathname({ resourceId }) : null, resourceAPI.update, {
    ...options,
    onSuccess,
  });
...
export const useDeleteResource = (
  ...
  useSWRMutation(resourceId ? getResourcePathname({ resourceId }) : null, resourceAPI.delete, {
    ...options,
    onSuccess,
  });
