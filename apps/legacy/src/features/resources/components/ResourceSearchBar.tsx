...
import type { ResourceSearchParamsSchema } from "@/services/resources/core/schema";
...
export default function ResourceSearchBar({ filters, onFilter }: ResourceSearchBarProps) {
        ...
        >
          <Container className="flex flex-col justify-between gap-4 md:flex-row">
            <Input
              ...
              suffixIcon={(v) =>
                (v.length > 0 || defaultQuery.length > 0) && <SendHorizontalIcon />
              }
              className="md:w-1/2"
            ...
            <div className="flex justify-end gap-3">
              <Button variant="outline" size="lg" color="primary" onClick={handleOpenFilter}>
