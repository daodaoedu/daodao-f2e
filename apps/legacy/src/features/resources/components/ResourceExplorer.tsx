...
export default function ResourceExplorer({ categories, parentDataCount }: ResourceExplorerProps) {
    ...
    <div className="flex flex-col gap-6">
      ...
      {filters.query && (
        <Container className="body-sm pb-6 text-basic-500">
          "{filters.query}" 共搜尋到
          <span className="mx-1 font-bold text-primary-base">{totalCount}</span>筆
        </Container>
      )}
