    ...
    openDialog({
      ...
      content: (
        <div className="mb-4 flex justify-between gap-2">
          <Button variant="ghost" size="icon" className="size-8" onClick={shareAPI.facebookShare}>
            <FacebookSvg className="text-[#1877F2]" />
          </Button>
          <Button variant="ghost" size="icon" className="size-8" onClick={shareAPI.threadsShare}>
            <ThreadsSvg className="text-black" />
          </Button>
          <Button variant="ghost" size="icon" className="size-8" onClick={shareAPI.linkedinShare}>
            <LinkedInSvg className="text-[#0A66C2]" />
          </Button>
          <Button variant="ghost" size="icon" className="size-8" onClick={shareAPI.xShare}>
            <XSvg className="text-black" />
          </Button>
          <Button variant="ghost" size="icon" className="size-8" onClick={shareAPI.lineShare}>
            <LineSvg className="text-[#00B900]" />
          </Button>
          <Button variant="ghost" size="icon" className="size-8" onClick={shareAPI.nativeShare}>
            <ShareWindowsSvg />
          </Button>
        </div>
      ),
