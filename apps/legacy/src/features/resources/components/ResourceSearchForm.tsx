...
import { costTypeOptions, resourceTypeOptions, targetAudienceTypeOptions } from "../constants";
...
export default function ResourceSearchForm({ onFilter, onClose, filters }: SearchFormProps) {
  const form = useForm({
