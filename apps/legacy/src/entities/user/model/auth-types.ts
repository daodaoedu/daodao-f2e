import type { CreateUserSchema, UpdateUserSchema, UserProfile } from "./constants";
...
export type AuthState = EmptyLoginState | TemporaryLoginState | PermanentLoginState;
...
export type AuthActions = {
  ...
  [AuthActionTypes.UPDATE_USER]: (payload: CreateUserSchema | UpdateUserSchema) => Promise<void>;
