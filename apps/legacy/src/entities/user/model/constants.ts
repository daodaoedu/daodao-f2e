...
export type CreateUserSchema = components["schemas"]["user.validators_createUserSchema"];

export type UpdateUserSchema = components["schemas"]["user.validators_updateUserSchema"];

// Professional Field enum
export type ProfessionalField = NonNullable<UserProfile["professionalField"]>[number];
 ...
 * 導航可見性類型
 */
export type NavVisibility = "all" | "auth" | "guest" | ((user: UserProfile | null) => boolean);
