  ...
  return (
    <>
      <header
        ...
        style={{
          maskImage: `url("${
            isMobile ? mobileIntersectMaskDataUri : desktopIntersectMaskDataUri
          }")`,
        }}
      >
        {isMobile ? (
          <MobileBannerSvg className="w-full" />
        ) : (
          <DesktopBannerSvg className="w-full" />
        )}
        <h1
          className={cn(
            ...
            isMobile
              ...
              : "top-[calc(3/13*100%)] -translate-y-full text-[1.75rem]"
          )}
        >
          我的小島
        </h1>
