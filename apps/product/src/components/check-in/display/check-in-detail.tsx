...
export const CheckInDetail = ({ checkInData, onEditComplete, afterTitle, isOwner = true }: ICheckInDetailProps) => {
          ...
          <DropdownMenuContent align="end">
            {isOwner ? (
              <>
                ...
                <DropdownMenuItem onClick={handleOpenBrowseActivity} className="gap-2 text-text-dark">
