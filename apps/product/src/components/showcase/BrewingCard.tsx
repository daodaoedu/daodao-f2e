...
export function BrewingCard({
  ...
  return (
    ...
    <div
      className="bg-white rounded-2xl p-4 overflow-hidden shadow-sm border border-[#E8F8FF] cursor-pointer hover:shadow-md hover:scale-[1.02] transition-all duration-200"
