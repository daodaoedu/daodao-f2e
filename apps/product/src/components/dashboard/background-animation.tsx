export const BackgroundAnimation = () => {
  return (
    <div className="absolute inset-0 overflow-hidden -z-10 bg-very-light-gray blur-[80px]">
      <div className="absolute top-2/7 right-1/8 rounded-full size-[198px] bg-[#DBF9FF] animate-float animate-duration-20000" />
