...
export const ExecutionDurationCard = ({
  ...
  return (
    <div className="relative bg-very-light-blue rounded-lg p-4 flex flex-col justify-between min-h-[120px]">
      {showRemaining ? (
        <div>
          <h3 className="text-xs text-text-dark">{t("duration_remaining_label")}</h3>
          <div className="flex items-baseline gap-0.5">
            ...
            <div className="text-xs text-text-dark">{t("duration_of_total")}</div>
        ...
        <div>
          <h3 className="text-xs text-text-dark">{t("duration_execution_length")}</h3>
          <div className="flex items-baseline gap-0.5">
      ...
      {(start || end) && (
        <div className="mt-2">
          {start && (
            <div>
              <div className="text-xs text-text-dark">{t("duration_start_day")}</div>
              <div className="text-sm text-logo-cyan">{format(start, "yyyy/MM/dd")}</div>
            </div>
          )}
          {end && (
            <div>
              <div className="text-xs text-text-dark">{t("duration_end_day")}</div>
