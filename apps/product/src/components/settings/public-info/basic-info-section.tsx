    ...
    <div className="bg-white rounded-xl p-4 space-y-4">
        ...
        render={({ field }) => (
          <FormItem>
            <FormLabel className="block font-medium text-text-dark mb-3">
              {t("name_label")}<span className="text-red ml-1">*</span>
            </FormLabel>
            <FormControl>
              <Input
                {...field}
      ...
      <FormField
        ...
        render={({ field }) => (
          <FormItem>
            <FormLabel className="block font-medium text-text-dark mb-3">
              {t("custom_id_label")}<span className="text-red ml-1">*</span>
            </FormLabel>
            <FormControl>
            ...
            <FormDescription className="text-xs text-light-gray mt-1">
              {t("custom_id_format_desc")}
              {customIdStatus === "available" && (
                <span className="text-green ml-1">{t("custom_id_available")}</span>
              )}
            </FormDescription>
            <FormMessage />
          </FormItem>
      ...
      <FormField
        ...
        render={({ field }) => (
          <FormItem>
            <FormLabel className="block font-medium text-text-dark mb-3">{t("country_label")}</FormLabel>
            <FormControl>
              <div className="relative">
                ...
                >
                  ...
                  >
                    <SelectValue placeholder={isLoadingCountries ? t("country_placeholder_loading") : t("country_placeholder")} />
                  </SelectTrigger>
                  <SelectContent>
                ...
                >
                  ...
                  >
                    <SelectValue
                      placeholder={
                        !selectedCountry
                          ? t("city_placeholder_no_country")
                          : isLoadingCities
                            ? t("city_placeholder_loading")
                            : t("city_placeholder")
                      }
                    />
                  </SelectTrigger>
