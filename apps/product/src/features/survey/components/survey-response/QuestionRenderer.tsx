...
import type { Answer, SurveyQuestion } from "../../types";
    ...
    <div className="space-y-3">
              ...
              >
                ...
                <input
                  ...
                  onChange={() => {
                    ...
                    handleChange(
                      selected ? current.filter((v) => v !== optId) : [...current, optId]
                    );
                  }}
                />
                {opt.label}
      ...
      {(question.questionType === "rating" || question.questionType === "scale") && (
        <div className="flex gap-2 flex-wrap">
          {Array.from({ length: question.questionType === "rating" ? 6 : 11 }, (_, i) => i).map(
            (n) => (
              <button
                key={n}
                type="button"
